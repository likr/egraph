...
import ImmutableGraph from "../src/graph/immutable-graph";
import MutableGraph from "../src/graph/mutable-graph";
import copy from "../src/graph/copy";

for (const [name, Graph] of [["ImmutableGraph", ImmutableGraph], ["MutableGraph", MutableGraph]]) {
  describe(name, () => {
